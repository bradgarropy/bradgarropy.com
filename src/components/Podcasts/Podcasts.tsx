        ...
        <div className="grid grid-cols-2 gap-8 max-[700px]:grid-cols-1">
            ...
            >
                <img
                    ...
                    alt="Compressed.fm"
                    className="box-border rounded border-3 border-black shadow-box transition duration-300 hover:shadow-none dark:border-white dark:shadow-box-white dark:hover:shadow-none"
                    width="500"
                    height="500"
                />
            </Link>
